...
<<<<<<< HEAD:Frontend/src/app/Views/System/Admin/Forms/register-company/register-company.component.ts
...
=======
import { CompanyService } from '../../../../Core/Service/System/company.service';
import { NitFormatterDirective } from '../../../../Components/Shared/Directives/nit-formatter.directive';
import { emailValidator } from '../../../../Core/Utils/input-validators.util';
import { CompanyCreateDTO } from '../../../../Core/Models/System/CompanyMod.model';
>>>>>>> parent of 845d2803 (solucion de errores):Frontend/src/app/Views/System/Admin/register-company/register-company.component.ts
...
export class RegisterCompanyComponent implements OnInit {
	...
	private nitValidator(control: AbstractControl): ValidationErrors | null {
		...
		// Patrón exacto: 9 dígitos + guión + 1 dígito verificador
	...
	getFieldError(fieldName: string): string {
		...
		if (field?.errors && (field.dirty || field.touched || this.wasSubmitted)) {
			...
			if (field.errors['invalidNIT']) return 'Formato de NIT inválido (Ej: 123456789-0)';
